...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAItXUp6uK41PrY"; // AccessKeyId

        $accessKeySecret = "mpH6o4kU1gNKr05TeTVwyZNINc1ZnG"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($member_tel) {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers($member_tel);

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("阳主页");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_157276513");
